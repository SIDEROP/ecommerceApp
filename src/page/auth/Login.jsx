...
import { loginUser, reLoginUser } from '../../store/slices/authSlice'; // Adjust the path according to your project structure
            ...
            <form className="form_container" onSubmit={handleSubmit}>
                ...
                <div className="title_container">
                    ...
                    <span className="subtitle">
                        Get started with our app, just login an account and
                ...
                <div className="input_container">
                    <label className="input_label" htmlFor="role_select">
                        Role
                    </label>
                    <select
                        id="role_select"
